...
const mainControlElement = document.querySelector(`.main__control.control.container`);
...
const renderAllElements = () => {
  ...
  renderBoardContent();
  renderComponent(document.querySelector(`.board.container`), getLoadMoreButton());
};
